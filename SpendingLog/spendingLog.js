...
<a class="dateTitle" href="../IndividualLog/individualLog.html?id=${encodeURIComponent( log._id,)}">
${log.duration_date[0]} to ${log.duration_date[1]}
</a>
<img class="deleteButton" src="../images/cross-svgrepo-com.svg" width="45" onclick="del('${log._id
}')">
</div>
`;
            htmlString += logHTML;
